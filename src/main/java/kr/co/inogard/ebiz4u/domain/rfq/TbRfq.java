...
import kr.co.inogard.ebiz4u.common.constant.*;
import kr.co.inogard.ebiz4u.domain.common.TbPurorg;
import kr.co.inogard.ebiz4u.domain.common.TbPurorgSub;
...
public class TbRfq {
    ...
    @Column(name = "spot_dscr_usrcd", columnDefinition = "char")
    ...
    @Column(name = "open_certno", columnDefinition = "char")
    ...
    @Enumerated(EnumType.STRING)
    private SelectYN notifyRebidYn;
    ...
    @Enumerated(EnumType.STRING)
    private TaxTypeCd taxTypeCd;

    @Column(name = "ws_choice_typecd", columnDefinition = "char", length = 1)
    @Enumerated(EnumType.STRING)
    private WsChoiceTypeCd wsChoiceTypeCd;
    ...
    @ManyToOne
    @JoinColumn(name = "sub_org_cd", columnDefinition = "char")
    private TbPurorgSub purorgSub;
